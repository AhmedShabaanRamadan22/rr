...
class FineBankController extends Controller
{
        ...
        return datatables($query)
            ->addColumn('action', function ($row) {
                return '<div class="d-flex justify-content-center">
                  ...
                  <button
                  class="btn btn-outline-danger btn-sm m-1  on-default m-r-5 deletefine_banks" data-model-id="' . $row->id . '">
    ...
    {
        if ($delete_model->fine_organizations->isNotEmpty()) {
            return trans('translation.delete-fine_organizations-first');
        }
        return '';
    }
}
