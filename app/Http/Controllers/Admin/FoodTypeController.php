...
class FoodTypeController extends Controller
{
        ...
        return datatables($query)
            ->addColumn('action', function ($row) {
                return '<div class="d-flex justify-content-center">
                  ...
                  <button
                  class="btn btn-outline-danger btn-sm m-1  on-default m-r-5 deletefood_types" data-model-id="' . $row->id . '">
    ...
    {
        if ($delete_model->foods->isNotEmpty()) {
            return trans('translation.delete-food-first');
        }
        return '';
    }
}
