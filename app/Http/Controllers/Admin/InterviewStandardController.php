...
class InterviewStandardController extends Controller
{
    ...
    {
        if ($delete_model->interview_standard_orders->isNotEmpty()) {
            return trans('translation.there-is-order-interview-link-with-it,cannot-delete');
        }
        return '';
    }
}
