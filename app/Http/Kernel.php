...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'external_api' => [
            ...
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            'throttle:api-client', // per-client throttling
        ],
    ];
    ...
    protected $middlewareAliases = [
        ...
        'organizationMiddleware' => \App\Http\Middleware\OrganizationMiddleware::class,
        'organizationAdmin' => \App\Http\Middleware\IsOrganizationAdmin::class,
        'superAdmin' => \App\Http\Middleware\IsSuperAdmin::class,
        'role' => \Spatie\Permission\Middlewares\RoleMiddleware::class,
        'permission' => \Spatie\Permission\Middlewares\PermissionMiddleware::class,
        'webLocalization' => \App\Http\Middleware\WebLocalization::class,
        'restrict.role' => \App\Http\Middleware\RestrictRoleMiddleware::class,
