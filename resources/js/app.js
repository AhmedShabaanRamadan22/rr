...
(function () {
				...
				if (document.querySelectorAll(".notification-item").length > 0) {
					...
					if (!emptyNotificationElem && document.getElementById("notificationItemsTabContent")) {
						...
						<div class="mt-3 avatar-md mx-auto">\
							<div class="avatar-title bg-info-subtle text-info fs-4 rounded-circle">\
							<i class="bi bi-bell "></i>\
							</div>\
						</div>\
						<div class="pb-3 mt-2">\
							<h6 class="fs-lg fw-semibold lh-base">لا توجد لديك أي إشعارات </h6>\
						</div>\
					</div>'
					}
				}
	...
	function updateFonts(layout) {
		...
		switch (layout) {
			case "default":
				fontLink.setAttribute("href", "https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@100;200;300;400;500;600;700&display=swap");
				break;
			case "material":
