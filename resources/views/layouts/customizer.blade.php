<!--start back-to-top-->
<button class="btn btn-primary btn-icon" id="back-to-top">
...
<div class="customizer-setting d-none d-md-block">
    <div class="btn p-2 text-uppercase rounded-end-0 shadow-lg bg-primary text-white" data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
        <i class="bi bi-gear mb-1"></i> {{trans('translation.customize')}}
    </div>
</div>
...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
        <div class="me-2">
            <h5 class="mb-1 text-white">خصائص العرض</h5>
            <p class="text-white text-opacity-75 mb-0">اختر السمات والتخطيطات الخاصة بك وما إلى ذلك.</p>
        </div>
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="p-4">
                <h6 class="fs-md mb-1">التخطيط</h6>
                <p class="text-muted fs-sm">اختر التخطيط المناسب لك</p>
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <h5 class="fs-sm text-center fw-medium mt-2">أفقي</h5>
                    </div>
                    <div class="col-4">
                        <div class="form-check card-radio">
                        ...
                        <h5 class="fs-sm text-center fw-medium mt-2">عرضي</h5>
                    </div>
                    <div class="col-4">
                        <div class="form-check card-radio">
                        ...
                        <h5 class="fs-sm text-center fw-medium mt-2">عامودين</h5>
                    </div>
                    <!-- end col -->
                </div>
                ...
                <h6 class="mt-4 fs-md mb-1">نظام الألوان</h6>
                <p class="text-muted fs-sm">اختر نظام فاتح أو داكن.</p>
                ...
                <div class="colorscheme-cardradio">
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">فاتح</h5>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">داكن</h5>
                        </div>
                ...
                <div id="layout-width">
                    <h6 class="mt-4 fs-md mb-1">عرض التخطيط</h6>
                    <p class="text-muted fs-sm">اختر تخطيطًا ناعماً أو محاصرًا.</p>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">ناعم</h5>
                        </div>
                        <div class="col-4">
                            <div class="form-check card-radio">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">محاصر</h5>
                        </div>
                    </div>
                </div>

                <div id="layout-position">
                    <h6 class="mt-4 fs-md mb-1">موقف التخطيط</h6>
                    <p class="text-muted fs-sm">اختر موضع التخطيط الثابت أو القابل للتمرير.</p>

                    <div class="btn-group radio" role="group">
                        <input type="radio" class="btn-check" name="data-layout-position" id="layout-position-fixed" value="fixed">
                        <label class="btn btn-light w-sm" for="layout-position-fixed">ثابت</label>

                        <input type="radio" class="btn-check" name="data-layout-position" id="layout-position-scrollable" value="scrollable">
                        <label class="btn btn-light w-sm ms-0" for="layout-position-scrollable">قابل للتمرير</label>
                    </div>
                </div>

                <h6 class="mt-4 fs-md mb-1">لون الشريط العلوي</h6>
                <p class="text-muted fs-sm">اختر لون الشريط العلوي الفاتح أو الداكن.</p>
                ...
                <div id="sidebar-size">
                    <h6 class="mt-4 fs-md mb-1">حجم الشريط الجانبي</h6>
                    <p class="text-muted fs-sm">اختر حجم الشريط الجانبي.</p>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">الحجم الطبيعي</h5>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">صغير (عرض الأيقونة)</h5>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">عرض صغير</h5>
                        </div>
                    </div>
                </div>

                <div id="sidebar-view">
                    <h6 class="mt-4 fs-md mb-1">عرض الشريط الجانبي</h6>
                    <p class="text-muted fs-sm">اختر عرض الشريط الجانبي الافتراضي أو المنفصل.</p>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">افتراضي</h5>
                        </div>
                        <div class="col-4">
                            <div class="form-check sidebar-setting card-radio">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">منفصل</h5>
                        </div>
                    </div>
                </div>
                <div id="sidebar-color">
                    <h6 class="mt-4 fs-md mb-1">لون الشريط الجانبي</h6>
                    <p class="text-muted fs-sm">اختر لون الشريط الجانبي.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">تدرج</h5>
                        </div>
                    </div>
                    <!-- end row -->
                ...
                <div id="sidebar-img">
                    <h6 class="mt-4 fw-semibold fs-base">صور الشريط الجانبي</h6>
                    <p class="text-muted fs-sm">اختر صورة للشريط الجانبي.</p>
                ...
                <div id="preloader-menu">
                    <h6 class="mt-4 fw-semibold fs-base">أداة التحميل المسبق</h6>
                    <p class="text-muted fs-sm">اختر أداة التحميل المسبق.</p>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">تفعيل</h5>
                        </div>
                        <div class="col-4">
                            <div class="form-check sidebar-setting card-radio">
                            ...
                            <h5 class="fs-sm text-center fw-medium mt-2">إبطال</h5>
                        </div>
                    </div>
    ...
    <div class="offcanvas-footer border-top p-3 text-center">
        <div class="row">
            <div class="col-12">
                <button type="button" class="btn btn-light w-100" id="reset-layout">إعادة ضبط</button>
            </div>
            {{-- <div class="col-6">
