@component('modals.delete-modal-template',['modalName'=>'assigned-user','modalRoute'=>'admin.orders-assigns',])
    <input type="hidden" name="order_ids" value="" id="hidden_order_ids_to_delete">
...
<script>
     $(document).ready(function() {
        ...
        $('#deleteassigned-user').on('show.bs.modal', function(e) {
            ...
            $(e.currentTarget).find('#hidden_order_ids_to_delete').val(JSON.stringify(orderIds));
