                        ...
                        @if ($organization->logo)
                            <div class="hide-on-print">
                                <img src="{{ $organization->logo ?? URL::asset('build/images/users/32/logo.png') }}"
                                    ...
                                    style="border: 2px solid {{ $organization->primary_color }};">
                            </div>
                        @endif
                        <div class="flex-grow-1">
                            <h6 class="fs-md px-3 mb-0">{{ $organization->name }}</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-0">
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-12 col-md-7 col-xl-6">
                        <ul class="nav nav-pills d-flex flex-wrap px-2" role="tablist">
                            @foreach ($periods as $period)
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link period-tabs d-flex align-items-center"
                                        id="meals_period_{{ $period->id }}_tab" data-bs-toggle="tab"
                                        data-bs-target="#meals_period_{{ $period->id }}" role="tab"
                                        aria-selected="false"
                    ...
                    <div class="col-12 col-md-2 text-md-end">
                        <button class="btn btn-primary btn-label hide-on-print w-100 w-md-auto" onclick="window.print();">
                ...
                <div class="tab-content">
                    @foreach ($periods as $period)
                        <div class="tab-pane fade" id="meals_period_{{ $period->id }}" role="tabpanel">
                            <div class="card card-body text-center" id="meal_period_container_{{ $period->id }}">
                                <div>
