<div class="row">
    ...
    <div class="col-lg-3 col-sm-12 my-auto">
        <button class="btn btn-primary" id="submitted-forms-filter-btn">{{trans('translation.filter')}}</button>
        <button class="btn btn-secondary" id="submitted-forms-reset-btn">{{trans('translation.reset')}}</button>
    </div>
</div>