            ...
            <div class="tab-content text-muted">
                ...
                <div class="tab-pane {{$loop->index == 0 ? 'active' : ''}}" id="operation-type-{{$operation_type->id}}" role="tabpanel">
                   @component('admin.organizations.components.bills-content.reason-dangers-template',['organization'=>$organization,'operation_type'=>$operation_type,'dangers'=>$dangers,'reason_danger'=>$operation_type->reason_dangers,'reason_dangers'=>$reason_dangers,'allReason'=>$allReason])@endcomponent
                </div>
                @endforeach
            </div>
