...
@component('components.organization-header', ['title' => 'meal-stages-organization', 'hide_button' => false])
@endcomponent

<x-data-table id="meal-stages-organization-datatable" :columns="$meal_organization_stages_columns"/>
...
<script>
    ...
    <script>
        $(document).ready(function() {
            ...
            //     width: '100%',
            // });
            window.organization_stages_datatable = $('#meal-stages-organization-datatable').DataTable({
                "ajax": {
