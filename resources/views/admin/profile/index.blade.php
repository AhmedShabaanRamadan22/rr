...
@endsection
@section('content')
@component('components.breadcrumb', ['pageTitle' => trans('profile')])
@endcomponent
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center border-bottom border-dashed">
                    ...
                    <img src="{{ URL::asset('build/images/users/32/profile-user.png') }}" alt="" class="avatar-lg rounded-circle p-1 img-thumbnail">
                    @else
                    <img src="{{ URL::asset('build/images/users/32/profile-user.png') }}" alt="" class="avatar-lg rounded-circle p-1 img-thumbnail">
                    @endif
                    <div class="my-3">
                        ...
                        <p class="text-primary badge bg-primary-subtle">{{ $organization->name_ar ?? trans('translation.not_found') }}</p>
                    </div>
                    ...
                    <div class="d-flex gap-2 py-4">
                        ...
                        <a href="{{ 'https://api.whatsapp.com/send?phone=' . $organization->phone }}" target="_blank" class="btn btn-outline-primary text-truncate w-100"><i class="bi bi-whatsapp align-baseline me-1"></i>
                ...
                <div class="border-bottom border-dashed py-4">
                    <h5 class="card-title mb-3">
                        <span>
                            {{ trans('translation.personal-info') }}
                        </span>
                        <a href="{{route('users.edit',$user->id)}}" class="float-end">
                        ...
                        <table class="table table-borderless table-sm align-middle mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-muted text-end"><a href='http://{{ $organization->domain??'' }}' target="_blank">{{ $organization->domain??'' }}</a></td>
                                </tr>
                                <tr>
                                    <th class="ps-0" scope="row">{{ trans('translation.organization-color') }}
                                    </th>
                                    @if (isset($organization->primary_color))
                                    <td class="text-muted text-end">
                                        <div class="badge" style="background-color: {{ $organization->primary_color }};color:{{ $organization->primary_color }}">
                                            ل</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-muted text-end">
                                        {{ isset($organization->has_esnad) && $organization->has_esnad == true ? trans('translation.translation.yes') : trans('translation.translation.no') }}
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="d-flex gap-2 align-items-center position-relative">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">
                                    {{ trans('translation.project-code') }}:
                                    <span class="px-2 text-bg-primary">
                                        {{ $category->code }}
                                    </span></p>
                            </div>
                        </div>
                        ...
                        @if (isset($organization))
                            ...
                            <div class="row">
                                <div class="col-xxl-9 mb-4">
                                    <h5 class="card-title mb-3">عن {{ $organization->name_ar ?? trans('translation.not_found') }}</h5>
                                    <p class="text-muted mb-2"> {!! is_found($organization->contract) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        @forelse ($organization->nationalities as $nationality)
                                        <span class="badge bg-primary-subtle text-primary">{!! $nationality->flag_icon !!} {{ $nationality->name}}</span>

                                        @empty <span class="badge bg-primary-subtle text-primary">{{ trans('translation.not_found') }}</span>
                                        @endforelse
                                        {{-- <span
                    ...
                    <div class="card-body">
                        <div class="acitivity-timeline acitivity-main">
                            <div class="acitivity-item d-flex">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/32/profile-user.png') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                </div>
                            ...
                            <div class="acitivity-item d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-muted mb-2"><span class="text-danger">2 days left</span>
                                        notification to submit the monthly sales report. <a href="javascript:void(0);" class="link-warning text-decoration-underline">Reports Builder</a></p>
