<div class="col-xl-6">
    <div class="card">
        <div class="card-header">
            <h6 class="card-title text-primary mb-0 flex-grow-1">{{trans("translation.total_" . $operations_label['label'] . " by danger")}}</h6>
        ...
        <div class="card-body">
            @component('components.charts.pie-chart', [
                'chartId' => $operations_label['label'] . 'DangerChartOrg' . ($organization->id??0),
