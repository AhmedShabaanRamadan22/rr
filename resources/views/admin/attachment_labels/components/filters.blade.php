...
<div class="row">
    ...
    <div class="col-lg-3 col-sm-12 my-auto">
        <button class="btn btn-primary" id="attachment-label-filter-btn">{{trans('translation.filter')}}</button>
        <button class="btn btn-secondary" id="attachment-label-reset-btn">{{trans('translation.reset')}}</button>
    </div>
</div>
